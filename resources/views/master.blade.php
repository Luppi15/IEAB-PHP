...
<head>
    ...
    <link href="/css/barra-superior.css" rel="stylesheet">
...
<body class="text-[#F2D6B3] background pt-4">


    <div class="button-container fixed top-0 left-1/2 transform -translate-x-1/2 mt-4 z-50">
        <button class="button" onclick="redirecionar('/')">
            <svg
                class="icon"
                stroke="currentColor"
                fill="currentColor"
        ...
        <button class="button" onclick="redirecionar('/biblia')">
            <svg
                class="icon"
                stroke="currentColor"
                fill="none"
        ...
        <button class="button" onclick="redirecionar('/ofertas')">
            <svg
                class="icon"
                stroke="currentColor"
                fill="none"
        ...
        <button class="button" onclick="redirecionar('/login')">
            <svg
                class="icon"
                stroke="currentColor"
                fill="currentColor"
